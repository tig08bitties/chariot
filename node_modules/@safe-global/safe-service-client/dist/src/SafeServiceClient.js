...
class SafeServiceClient {
    ...
    async getServiceInfo() {
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/about`,
    ...
    async getServiceMasterCopiesInfo() {
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/about/master-copies`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async decodeData(data) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/data-decoder/`,
    ...
    async getSafesByOwner(ownerAddress) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/owners/${address}/safes/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getSafesByModule(moduleAddress) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/modules/${address}/safes/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getTransaction(safeTxHash) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/multisig-transactions/${safeTxHash}/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getTransactionConfirmations(safeTxHash) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/multisig-transactions/${safeTxHash}/confirmations/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getSafeInfo(safeAddress) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getSafeDelegates(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/delegates/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async addSafeDelegate({ safe, delegate, label, signer }) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${safeAddress}/delegates/`,
            method: httpRequests_1.HttpMethod.Post,
            body
        });
    }
    ...
    async removeSafeDelegate({ safe, delegate, signer }) {
        ...
        const signature = await signer.signMessage(data);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${safeAddress}/delegates/${delegateAddress}`,
            method: httpRequests_1.HttpMethod.Delete,
            body: {
                safe: safeAddress,
                delegate: delegateAddress,
    ...
    async getSafeCreationInfo(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/creation/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async estimateSafeTransaction(safeAddress, safeTransaction) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/multisig-transactions/estimations/`,
            method: httpRequests_1.HttpMethod.Post,
    ...
    async proposeTransaction({ safeAddress, safeTransactionData, safeTxHash, senderAddress, senderSignature, origin }) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${safe}/multisig-transactions/`,
            method: httpRequests_1.HttpMethod.Post,
            body: {
                ...safeTransactionData,
    ...
    async getIncomingTransactions(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/incoming-transfers/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getModuleTransactions(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/module-transactions/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getMultisigTransactions(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/multisig-transactions/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getPendingTransactions(safeAddress, currentNonce) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/multisig-transactions/?executed=false&nonce__gte=${nonce}`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getAllTransactions(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        const url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/all-transactions/`);
    ...
    async getBalances(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        const url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/balances/`);
    ...
    async getUsdBalances(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        const url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/safes/${address}/balances/usd/`);
        const excludeSpam = ((_a = options === null || options === void 0 ? void 0 : options.excludeSpamTokens) === null || _a === void 0 ? void 0 : _a.toString()) || 'true';
        url.searchParams.set('exclude_spam', excludeSpam);
        return (0, httpRequests_1.sendRequest)({ url: url.toString(), method: httpRequests_1.HttpMethod.Get });
    }
    ...
    async getCollectibles(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        const url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v2/safes/${address}/collectibles/`);
        const limit = ((_a = options === null || options === void 0 ? void 0 : options.limit) === null || _a === void 0 ? void 0 : _a.toString()) || '10';
        url.searchParams.set('limit', limit);
        const offset = ((_b = options === null || options === void 0 ? void 0 : options.offset) === null || _b === void 0 ? void 0 : _b.toString()) || '0';
        url.searchParams.set('offset', offset);
        const excludeSpam = ((_c = options === null || options === void 0 ? void 0 : options.excludeSpamTokens) === null || _c === void 0 ? void 0 : _c.toString()) || 'true';
        url.searchParams.set('exclude_spam', excludeSpam);
        return (0, httpRequests_1.sendRequest)({ url: url.toString(), method: httpRequests_1.HttpMethod.Get });
    }
    /**
    ...
    async getTokenList() {
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/tokens/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getToken(tokenAddress) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/v1/tokens/${address}/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
}
