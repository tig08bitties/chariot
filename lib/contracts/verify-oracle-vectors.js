...
async function verifyOracleVectors() {
  ...
  try {
    ...
    try {
      ...
      const verification = {
        DAUS: vectors[0].toLowerCase() === canonicalVectors.DAUS.toLowerCase(),
        ALIMA: vectors[1].toLowerCase() === canonicalVectors.ALIMA.toLowerCase(),
        COVENANT_ROOT: vectors[2].toLowerCase() === canonicalVectors.COVENANT_ROOT.toLowerCase(),
        TREASURY_OF_LIGHT: vectors[3].toLowerCase() === canonicalVectors.TREASURY_OF_LIGHT.toLowerCase(),
        ARCHITECT: vectors[4].toLowerCase() === canonicalVectors.ARCHITECT.toLowerCase(),
        LEDGER_OWNER: vectors[5].toLowerCase() === canonicalVectors.LEDGER_OWNER.toLowerCase(),
