...
const RUBY_TXT_CORRECTIONS = {
  ...
  // TRUNCATED HASHES IN RUBY.TXT - ✅ NOW CORRECTED (2024-12-10)
  // The middle 8 letters (positions 11-18: Kaf through Qof) had truncated hashes.
  // These were the "veiled middle" - visible in either direction (forward/backward).
  // Now unveiled and complete:
  truncatedHashes: [
    { letter: 'כ Kaf',    added: '9',  now: 'f0e1d2c3b4a5968775647382910a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f89' },
    { letter: 'מ Mem',    added: '76', now: 'd4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d476' },
    { letter: 'נ Nun',    added: 'ff', now: 'e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6ff' },
    { letter: 'ס Samekh', added: '56', now: 'a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a856' },
    { letter: 'ע Ayin',   added: '34', now: 'c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c034' },
    { letter: 'פ Pe',     added: 'a5', now: 'e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2a5' },
    { letter: 'צ Tsade',  added: 'c5', now: 'f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4c5' },
    { letter: 'ק Qof',    added: 'd6', now: 'a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6d6' },
  ],
  status: 'CORRECTED' // Ruby.txt now matches I_AM.txt
};
